...
Get a key at [API Management](https://www.kolmopdf.com/api-keys). The skill calls the API through Bash/curl; MCP is optional.
...
[SKILL.md](SKILL.md) contains the routing and cost rules. [Chain recipes](references/chain-recipes.md) cover multi-step operations, and the [parameter glossary](references/parameter-glossary.md) lists API fields.
